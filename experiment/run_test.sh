...
# ./../Release/indexbuilder -c config/build_sift1m.ini -d 128 -v float -f XVEC -i /data/users/ycli/sift/sift_base.fvecs -o sift1m -a SPANN

max_check_values=(8192 16384)
